      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-primary-foreground/60 text-sm leading-relaxed">
              Smart wardrobe management app. Style with AI.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="#pricing" className="text-primary-foreground/60 hover:text-primary-foreground text-sm transition-colors">
                  Pricing
                </Link>
              </li>
              <li>
                <Link href="#faq" className="text-primary-foreground/60 hover:text-primary-foreground text-sm transition-colors">
                  FAQ
                </Link>
              </li>
            </ul>
        ...
        <div className="pt-8 border-t border-primary-foreground/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-primary-foreground/60 text-sm">
            © 2026 Awardrobe. All rights reserved.
          </p>
